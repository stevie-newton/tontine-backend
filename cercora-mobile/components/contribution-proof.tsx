...
function ProofModal({ contributionId, onClose }: ContributionProofProps & { onClose: () => void }) {
  ...
  return (
    <Modal visible animationType="fade" presentationStyle="fullScreen" onRequestClose={onClose}>
      <SafeAreaProvider>
        <SafeAreaView style={[styles.modal, { backgroundColor }]} accessibilityViewIsModal onAccessibilityEscape={onClose}>
          <View style={styles.header}>
            ...
            <Pressable
              ...
              onPress={onClose}
              style={[styles.closeButton, { borderColor: buttonColor }]}
            >
          ...
          <View style={styles.footer}>
            <AppButton label={t("Close payment proof")} onPress={onClose} />
          </View>
        </SafeAreaView>
      </SafeAreaProvider>
    </Modal>
...
const styles = StyleSheet.create({
  ...
  modal: { flex: 1 },
  header: { flexDirection: "row", alignItems: "center", gap: 16, padding: 16, flexShrink: 0 },
  title: { flex: 1 },
  closeButton: { minWidth: 64, minHeight: 48, alignItems: "center", justifyContent: "center", padding: 8, borderWidth: 1, borderRadius: 12 },
  imageArea: { flex: 1, minHeight: 0, overflow: "hidden", marginHorizontal: 16 },
  footer: { padding: 16, flexShrink: 0 },
