...
const frTranslations: Record<string, string> = {
  ...
  "Read tester feedback and track what needs attention.": "Consultez les retours des testeurs et suivez les probl?mes ? traiter.",
  "Open reports": "? traiter",
  "Resolved reports": "R?solus",
  "All reports": "Tous",
  "Refresh reports": "Actualiser les signalements",
  "Report marked as resolved.": "Signalement marqu? comme r?solu.",
  "Report reopened.": "Signalement rouvert.",
  "Unable to update reports. Refresh to check their latest status.": "Impossible de mettre ? jour les signalements. Actualisez pour v?rifier leur ?tat.",
  "No reports in this category.": "Aucun signalement dans cette cat?gorie.",
  "Unknown sender": "Exp?diteur inconnu",
  "Resolved": "R?solu",
  "Show less": "Afficher moins",
  "Read full report": "Lire le signalement complet",
  "Reopen report": "Rouvrir le signalement",
  "Mark as resolved": "Marquer comme r?solu",
  "Loading reports...": "Chargement des signalements...",
  "Load older reports": "Charger les signalements pr?c?dents",
  "Report a problem": "Signaler un problème",
  "Beta feedback": "Retours sur la bêta",
  "Tell us where you got stuck so we can improve Cercora.": "Dites-nous où vous avez rencontré un problème pour nous aider à améliorer Cercora.",
  "Where did you get stuck?": "À quelle étape avez-vous rencontré un problème ?",
  "e.g. Joining a tontine or making a payment": "Par exemple : rejoindre une tontine ou effectuer un paiement",
  "What happened?": "Que s’est-il passé ?",
  "Tell us what you tried, what happened, and what you expected.": "Décrivez ce que vous avez essayé, ce qui s’est passé et le résultat attendu.",
  "Signing in": "Connexion",
  "Enter the screen or step where you got stuck.": "Indiquez l’écran ou l’étape où vous avez rencontré un problème.",
  "Describe what happened (at least 10 characters).": "Décrivez ce qui s’est passé (au moins 10 caractères).",
  "Enter your name.": "Saisissez votre nom.",
  "Enter a valid phone number.": "Saisissez un numéro de téléphone valide.",
  "We use your name and phone number to follow up on your report.": "Nous utilisons votre nom et votre numéro de téléphone pour vous recontacter au sujet de votre signalement.",
  "Please leave out passwords, verification codes, and payment details.": "N’incluez pas de mots de passe, de codes de vérification ni de coordonnées de paiement.",
  "App version and device software are included to help us investigate.": "La version de l’application et du système de votre appareil est incluse pour nous aider à comprendre le problème.",
  "Send report": "Envoyer le signalement",
  "Sending report...": "Envoi du signalement...",
  "Report received": "Signalement reçu",
  "Your report has been saved. Thank you for helping us improve Cercora.": "Votre signalement a été enregistré. Merci de nous aider à améliorer Cercora.",
  "Report #{{id}}": "Signalement nº {{id}}",
  "We could not confirm that your report was received. Your text is still here; please try again.": "Nous n’avons pas pu confirmer la réception de votre signalement. Votre texte est conservé ici ; veuillez réessayer.",
  "Back": "Retour",
  "Done": "Terminé",
  "Close": "Fermer",
  "Choose a smaller screenshot (up to 24 megapixels).": "Choisissez une capture plus petite (24 mégapixels maximum).",
  "Choose a screenshot smaller than 5 MB.": "Choisissez une capture de moins de 5 Mo.",
  "Enter a transaction reference (up to 120 characters).": "Saisissez une référence de transaction (120 caractères maximum).",
  "Unable to open this image. Please choose another screenshot.": "Impossible d’ouvrir cette image. Choisissez une autre capture.",
  "Contribution submitted": "Cotisation envoyée",
  "Awaiting beneficiary confirmation. Your payment is not confirmed yet.": "En attente de confirmation du bénéficiaire. Votre paiement n’est pas encore confirmé.",
  "Payment proof attached": "Justificatif de paiement joint",
  "Enter your transfer amount and reference. You can also attach a screenshot for review.": "Saisissez le montant et la référence du transfert. Vous pouvez aussi joindre une capture pour vérification.",
  "Required, even when you attach a screenshot.": "Obligatoire, même si vous joignez une capture.",
  "Payment proof (optional)": "Justificatif de paiement (facultatif)",
  "Attach one screenshot, up to 5 MB. Only you and the beneficiary can view it.": "Joignez une capture de 5 Mo maximum. Seuls vous et le bénéficiaire pouvez la consulter.",
  "Selected payment proof": "Justificatif de paiement sélectionné",
  "Check that the amount and reference are readable before submitting.": "Vérifiez que le montant et la référence sont lisibles avant l’envoi.",
  "Remove screenshot": "Retirer la capture",
  "Preparing screenshot...": "Préparation de la capture...",
  "Replace screenshot": "Remplacer la capture",
  "Add payment proof": "Ajouter un justificatif",
  "Screenshot uploads are currently unavailable. You can still submit your transaction reference.": "L’envoi de captures est actuellement indisponible. Vous pouvez toujours envoyer votre référence de transaction.",
  "Uploading proof: {{percent}}%": "Envoi du justificatif : {{percent}} %",
  "Keep this screen open until submission finishes.": "Gardez cet écran ouvert jusqu’à la fin de l’envoi.",
  "View payment proof": "Voir le justificatif",
  "Payment proof": "Justificatif de paiement",
  "Close payment proof": "Fermer le justificatif",
  "Loading payment proof...": "Chargement du justificatif...",
  "Unable to load payment proof. Please try again.": "Impossible de charger le justificatif. Veuillez réessayer.",
  "Payment proof screenshot": "Capture du justificatif de paiement",
  ...
  "Enable faster sign-in on this device.": "Activez la connexion rapide sur cet appareil.",
  "Or sign in with your phone and password.": "Ou connectez-vous avec votre téléphone et votre mot de passe.",
  Notifications: "Notifications",
  "Choose your app language.": "Choisissez la langue de l’application.",
  "Contribution reminders": "Rappels de cotisation",
  "Manage alerts and notification permissions.": "Gérez les alertes et les autorisations de notification.",
  "Manage notifications": "Gérer les notifications",
  Upcoming: "À venir",
  "Stay on top of your contributions.": "Gardez un œil sur vos cotisations.",
  "Showing previously loaded reminders.": "Affichage des rappels chargés précédemment.",
  "Reminder cycle {{number}}": "Cycle {{number}}",
  "Notifications are unavailable on this device.": "Les notifications sont indisponibles sur cet appareil.",
  "Notifications are blocked in your browser settings.": "Les notifications sont bloquées dans les paramètres du navigateur.",
  "View cycles": "Voir les cycles",
  "Search tontines": "Rechercher des tontines",
  "Clear search": "Effacer la recherche",
  "No matching tontines": "Aucune tontine correspondante",
  "Try another name or filter.": "Essayez un autre nom ou filtre.",
  "Reset filters": "Réinitialiser les filtres",
  "No current cycle": "Aucun cycle en cours",
  Home: "Accueil",
  "Active tontines": "Tontines actives",
  "Your savings, together": "Votre épargne, ensemble",
  "Hello, {{name}}": "Bonjour, {{name}}",
  "Contribution overdue": "Cotisation en retard",
  "Next contribution": "Prochaine cotisation",
  "Reminders are unavailable": "Les rappels sont indisponibles",
  "Pull down to try again.": "Faites glisser vers le bas pour réessayer.",
  "No contribution reminders right now.": "Aucun rappel de cotisation pour le moment.",
  "Could not refresh your tontines.": "Impossible d’actualiser vos tontines.",
  "Start your first circle": "Créez votre première tontine",
  "Save together with people you trust.": "Épargnez avec des personnes de confiance.",
  "Loading home": "Chargement de l’accueil",
  "View reminders": "Voir les rappels",
  "View cycle details": "Voir les détails du cycle",
  "Pending invitations": "Invitations en attente",
  Preferences: "Préférences",
  Security: "Sécurité",
  "View details": "Voir les détails",
  "Hide details": "Masquer les détails",
  "Account deletion is permanent. Active tontines or protected financial records may prevent deletion.": "La suppression du compte est définitive. Des tontines actives ou des données financières protégées peuvent empêcher sa suppression.",
  "New password": "Nouveau mot de passe",
  Due: "Échéance",
  "Open a group or create a new savings circle.": "Ouvrez un groupe ou créez une nouvelle tontine.",
  "{{count}} group(s)": "{{count}} groupe(s)",
  "Admin access required": "Accès administrateur requis",
  "This area is available only to Cercora global administrators.": "Cet espace est réservé aux administrateurs généraux de Cercora.",
  Administration: "Administration",
  "Admin center": "Centre d’administration",
  "Monitor platform health, groups, risk, and reminder delivery.": "Suivez l’état de la plateforme, les groupes, les risques et l’envoi des rappels.",
  "Platform overview": "Vue d’ensemble de la plateforme",
  "Key activity and risk signals": "Indicateurs clés d’activité et de risque",
  "Refresh admin data": "Actualiser les données d’administration",
  "Loading admin overview": "Chargement de la vue d’ensemble de l’administration",
  "Recent groups and current status": "Groupes récents et état actuel",
  members: "membres",
  "Preview and send pre-deadline SMS": "Consulter et envoyer les SMS avant l’échéance",
  Recipients: "Destinataires",
  "Checking upcoming deadlines...": "Vérification des prochaines échéances...",
  "{{count}} overdue reminder(s) need attention.": "{{count}} rappel(s) en retard nécessitent votre attention.",
  "{{count}} upcoming reminder(s).": "{{count}} rappel(s) à venir.",
  "You are all caught up.": "Vous êtes à jour.",
  "Get contribution reminders and important Cercora updates.": "Recevez les rappels de cotisation et les informations importantes de Cercora.",
  "Turns push notifications on or off": "Active ou désactive les notifications",
  "Due {{date}}": "Échéance : {{date}}",
  "Admin controls": "Commandes d’administration",
  "Updating...": "Mise à jour...",
  All: "Tous",
  Processed: "Traités",
  "Total payout value": "Montant total des paiements",
  "{{count}} payouts": "{{count}} paiements",
  "No matching payouts": "Aucun paiement correspondant",
  "Try another filter or check back as payout records are updated.": "Essayez un autre filtre ou revenez après la mise à jour des paiements.",
  Other: "Autres",
  "No matching transactions": "Aucune transaction correspondante",
  "Try another filter or check back when new ledger activity is recorded.": "Essayez un autre filtre ou revenez lorsque de nouvelles opérations sont enregistrées.",
  "Delete tontine": "Supprimer la tontine",
  "Delete this tontine only if it has no contributions, payments, payouts, debts, or ledger activity. This action cannot be undone.": "Supprimez cette tontine uniquement si elle ne comporte aucune cotisation, aucun paiement, aucun versement, aucune dette ni aucune opération comptable. Cette action est irréversible.",
  "Tontine group": "Groupe de tontine",
  "{{current}} of {{total}}": "{{current}} sur {{total}}",
  "Group activity": "Activité du groupe",
  "Cycle {{current}} of {{total}}": "Cycle {{current}} sur {{total}}",
  "No cycles generated": "Aucun cycle généré",
  "Review payout history": "Consulter l’historique des paiements",
  "If that phone exists, a reset code was sent.": "Si ce numéro est enregistré, un code de réinitialisation a été envoyé.",
  "Password reset successful. You can now sign in.": "Votre mot de passe a été réinitialisé. Vous pouvez maintenant vous connecter.",
  "Phone verified. You can now sign in.": "Votre numéro de téléphone a été vérifié. Vous pouvez maintenant vous connecter.",
  "OTP sent.": "Code de vérification envoyé.",
  "Native push is not supported on this platform.": "Les notifications mobiles ne sont pas prises en charge sur cette plateforme.",
  "Native push requires a physical device.": "Les notifications mobiles nécessitent un appareil physique.",
  "Notification permission not granted.": "L’autorisation d’envoyer des notifications n’a pas été accordée.",
  "Missing EAS project ID for push registration.": "Les notifications ne sont pas encore configurées pour cette application.",
  "Missing EXPO_PUBLIC_WEB_PUSH_VAPID_PUBLIC_KEY": "Les notifications web ne sont pas encore configurées.",
  "Unexpected login response": "La réponse du serveur de connexion est inattendue.",
  "Invalid phone or password": "Numéro de téléphone ou mot de passe incorrect",
  "Biometric sign in": "Connexion biométrique",
  "Face unlock": "Reconnaissance faciale",
  Fingerprint: "Empreinte digitale",
  "Use {{label}} to continue in Cercora.": "Utilisez {{label}} pour continuer dans Cercora.",
  "{{label}} was cancelled.": "L’authentification avec {{label}} a été annulée.",
  "{{label}} is not available on this device.": "L’authentification avec {{label}} n’est pas disponible sur cet appareil.",
  "{{label}} did not recognize you. Please try again.": "L’authentification avec {{label}} a échoué. Veuillez réessayer.",
  "Unable to use {{label}} right now.": "Impossible d’utiliser {{label}} pour le moment.",
  "{{label}} is not set up on this device.": "L’authentification avec {{label}} n’est pas configurée sur cet appareil.",
  "Saved {{label}} credentials are no longer valid. Sign in with your password to enable it again.": "Les identifiants enregistrés pour {{label}} ne sont plus valides. Connectez-vous avec votre mot de passe pour réactiver cette méthode.",
  ...
  "We could not find your phone number for biometric setup.":
    "Nous n’avons pas pu trouver votre numéro de téléphone pour configurer la connexion biométrique.",
  "Enter your current password to enable biometric sign-in.":
    "Entrez votre mot de passe actuel pour activer la connexion biométrique.",
  ...
  "Confirm your password to turn on biometric sign-in for this device.":
    "Confirmez votre mot de passe pour activer la connexion biométrique sur cet appareil.",
  ...
  "{{frequency}} contribution cadence": "Fréquence des cotisations : {{frequency}}",
...
export function translateText(text: string, params?: TranslationParams) {
