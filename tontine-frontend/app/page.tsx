...
const copy = {
  en: {
    ...
    playStoreLabel: "Join the Cercora Android beta on Google Play",
    playStoreEyebrow: "Join the Android beta",
  ...
  fr: {
    ...
    playStoreLabel: "Rejoindre la bêta Android Cercora sur Google Play",
    playStoreEyebrow: "Rejoindre la bêta Android",
    playStoreName: "Google Play",
